...
<html lang="en">
  ...
  <body>
    <div class="content update">
      ...
      <form>
        <label class = "table" for="base_salary">Base Salary</label>
        <input type="number" id="base_salary" placeholder="Enter Base Salary" />

        <label class = "table" for="meal_allowance">Meal Allowance</label>
        ...
        <label class = "table" for="meal_allowance_amount">Meal Allowance Amount</label>
        <input
          type="number"
        ...
        />
            ...
            <label class = "table" for="meal_days">How many days did you work?</label>
            <input
                    required
                    type="number"
                    id="meal_days"
